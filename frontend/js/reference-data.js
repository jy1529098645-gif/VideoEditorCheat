...

{
  ...
  "evidence": {
    "ER": "≤50字，引用稿子具体片段或缺失要素，说明给这个 ER 分的依据",
    "SR": "≤50字，同上",
    "HP": "≤50字，说明开场前 100 字的具体表现",
    "QL": "≤50字，指出哪些句子是金句 / 或全无金句",
    "NA": "≤50字，叙事结构或列表式的具体证据",
    "AB": "≤50字，议题受众面的判断依据",
    "SAT": "≤50字，反讽层数或真诚陈述的证据"
  },
  "reason": "一句话核心驱动 + 最强反例约束 + 中枢预测（≤50字）",
  "factors": [
...
evidence 字段要求：必须 **引用稿子里的具体片段**（用「...」括起）或明确指出"缺失什么"。不要写"情感强"这种空话，要写"第二段「我曾经以为...」+ 反思人称密度高 → ER=4"。

# JSON 格式硬约束（违反会导致解析失败）
- **绝对不要在字符串值内部使用 ASCII 双引号**。如果你要在 reason / note / closest_anchor 中引用某个词或句子，**用中文引号「」/『』 或单引号**。
  错误示例: "reason": "ER 靠 (英文双引号)数字难民(英文双引号) 共鸣"  这会让 JSON 炸掉
  正确示例: "reason": "ER 靠「数字难民」共鸣"
- 所有字符串里不要换行符
